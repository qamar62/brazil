                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex gap-3">
                      <a
                        href={`https://wa.me/+971123456789?text=Olá, tenho interesse no tour ${tour.title}`}
                        target="_blank"
                      ...
                      <button
                        className="flex-1 bg-yellow-500 hover:bg-primary/90 text-white py-2 px-4 rounded-full text-sm font-medium transition-all flex items-center justify-center gap-2"
                      >
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M19 10h-2V7c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v3H7c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zm-8-3h2v3h-2V7zm8 13H7v-8h12v8z"/>
                        </svg>
                        Reservar Agora
                      </button>
                    </div>
